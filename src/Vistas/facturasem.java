 ...
 * @author Dayana
 */
public class facturasem extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        pempleado.add(jLabel8, new org.netbeans.lib.awtextra.AbsoluteConstraints(30, 20, -1, -1));
    ...
    private void btnempleado1ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnempleado1ActionPerformed
        registrovyc registrovycFrame = new registrovyc(); 
        registrovycFrame.setVisible(true);
        dispose();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(facturasem.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new facturasem().setVisible(true);
            }
        });
    }
